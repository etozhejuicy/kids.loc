<section class="section section-content section-target" id="ourTarget" data-scroll-center>
    <div class="container">
        <div class="section-target-inner">
            ...
            <div class="section-target-content">
                <!-- Зона изображения секции -->
                <div class="section-target-background">
                    <img data-src="/assets/images/pages/main/sections/target/bg.svg" class="lazyload wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.05s" />
                </div>
                <!-- Зона со списком -->
