<section class="section section-content section-post">
    <div class="container">
        <div class="section-post-inner">
            ...
            <div class="section-post-title text-center text-md-left">
                <h3 class="h-1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0s">
                    Заголовок
                </h3>
            </div>
            <!-- Зона контента новости -->
            <div class="section-post-content wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.05s">
                <!-- Параграфы -->
                <p>
